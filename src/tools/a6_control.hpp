...
struct Options {
    ...
    bool then_jog_vel = false;       // --move-pos POS --then-jog-vel VEL: after the PP move REACHES, SWITCH to PV (§6) and jog at VEL until Ctrl-C (drives the canonical mode-switch on the wire)
};
